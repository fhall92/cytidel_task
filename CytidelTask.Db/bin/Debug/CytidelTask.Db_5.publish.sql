...
GO
PRINT N'Altering Procedure [dbo].[pr_task_get_all]...';
...
-- =============================================
ALTER PROCEDURE [pr_task_get_all] 
AS
BEGIN
...
END
GO
PRINT N'Altering Procedure [dbo].[pr_task_get_by_status]...';
...
-- =============================================
ALTER PROCEDURE [pr_task_get_by_status] 
	@Status int = 0
AS
BEGIN
	SELECT * FROM task 
